  ...
  <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
    <div class="bg-white shadow-sm sm:rounded-lg">
      <div class="p-12 bg-white border-b border-gray-200">
        <h1 class="text-2xl mb-6">Cadastrar Disco</h1>
        @if ($errors->any())
        ...
        <form action="{{ route('disks.store') }}" method="post">
          ...
          <label>Artista</label>
          <input name="artista" class="block mb-6 w-full" type="text" maxlength="60">
          <div class="flex justify-between gap-6">
            ...
            <span class="w-1/3">
              ...
              <input name="ano" class="block mb-6 w-full" type="number">
            </span>
          </div>
          <div class="flex justify-between gap-3">
            <span class="w-1/3">
              <label>Qtd. Exemplares</label>
              <input name="qtd_exemplares" class="block mb-6 w-full" type="number">
            </span>
            <span class="w-1/3">
              <label>Qtd. Disponível</label>
              <input name="qtd_disponivel" class="block mb-6 w-full" type="number">
            </span>
            <span class="w-1/3">
              <label>Preço</label>
